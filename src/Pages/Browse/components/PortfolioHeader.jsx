      ...
      <div className="px-6 py-10">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-8 border-b border-gray-700 pb-10">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-400 text-center md:text-left mt-2 text-lg">
              {profile.bio}
            </p>
            <div className="flex flex-col md:flex-row items-center gap-6 mt-4">
              <span className="flex items-center text-center md:text-left gap-1">
              ...
              <span className="flex items-center text-center md:text-left gap-1 text-gray-400">
